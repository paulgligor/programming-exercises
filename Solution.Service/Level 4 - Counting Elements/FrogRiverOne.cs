...
namespace Solution.Service
{
    public class FrogRiverOne
    {
        /*
            ...
            river from 1 to X (that is, we want to find the earliest moment when all the positions from 1 to X are covered by leaves). You may assume that the speed of the current 
